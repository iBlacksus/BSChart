...
class BSChartTitlesFlowLayout: UICollectionViewFlowLayout {
...
fileprivate extension UICollectionViewLayoutAttributes {
    ...
    func isRepresentingFirstItemInLine(collectionViewLayout: BSChartTitlesFlowLayout) -> Bool {
        if currentItem <= 0 {
            return true
        }
        else {
    ...
    func isRepresentingLastItemInLine(collectionViewLayout: BSChartTitlesFlowLayout) -> Bool {
    ...
    private func alignToPrecedingItem(collectionViewLayout: BSChartTitlesFlowLayout) {
    ...
    private func alignToFollowingItem(collectionViewLayout: BSChartTitlesFlowLayout) {
        let itemSpacing = collectionViewLayout.minimumInteritemSpacing
    ...
    func alignHorizontally(collectionViewLayout: BSChartTitlesFlowLayout) {
    ...
    func alignVertically(collectionViewLayout: BSChartTitlesFlowLayout) {
